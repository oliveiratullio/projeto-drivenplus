...
export default function Plan3Page(){
    ...
    const [body, setBody] = useState({ cardName: '', cardNumber: '', securityNumber: '', expirationDate: '', membershipId: 3,});
  ...
  function handleSubmit(e) {
    ...
    useEffect(() => {
        const promise = axios.get('https://mock-api.driven.com.br/api/v4/driven-plus/subscriptions/memberships/3', {
            headers: {
              'Authorization': `Bearer ${data.auth.token}`
            }
          })
            ...
            <Container>
                ...
                <PlanData>
                    ...
                    <DataLine2>
                        ...
                        <p>4. Mentorias personalizadas</p>
                    </DataLine2>
                    <DataLine1>
                        <FaMoneyBillWaveAlt color="#ed6590" width="15px" height="10.5px" />
                        Preco:
                    </DataLine1>
                    <DataLine2><p>R$ 99,99 cobrados mensalmente</p></DataLine2>
                </PlanData>
